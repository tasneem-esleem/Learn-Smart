...
export default function Achievements() {
  return (
    <section className="w-full px-4 sm:px-8 md:px-16 lg:px-28 py-16 sm:py-20 md:py-28 lg:py-32">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 justify-items-center">
        {stats.map((stat) => (
          <div
            key={stat.id}
            className="bg-white rounded-2xl px-6 sm:px-8 py-8 sm:py-10 flex flex-col items-center text-center w-full max-w-[250px] sm:max-w-none

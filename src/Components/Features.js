...
export default function Features() {
  ...
  return (
    <section className="w-full bg-[#38B7930D] px-4 sm:px-10 lg:px-28 py-8 sm:py-12 lg:py-16 flex flex-col lg:flex-row items-center lg:items-start justify-center overflow-hidden">
      ...
      <div className="relative w-[220px] h-[300px] sm:w-[280px] sm:h-[380px] lg:w-[320px] lg:h-[440px] mx-0 sm:mx-10 lg:mx-28 flex-shrink-0 mb-10 lg:mb-0">
        <motion.img
          ...
          loading="lazy"
          className="absolute top-0 right-0 w-[180px] h-[280px] sm:w-[230px] sm:h-[350px] lg:w-[268px] lg:h-[415px] object-cover rounded-3xl z-20 transition-transform duration-500 hover:scale-105"
        />
        ...
        <motion.img
          ...
          loading="lazy"
          className="absolute -bottom-20 -left-20 sm:-bottom-28 sm:-left-28 lg:-bottom-32 lg:-left-32 w-[180px] h-[280px] sm:w-[230px] sm:h-[350px] lg:w-[268px] lg:h-[415px] object-cover rounded-3xl z-10 transition-transform duration-500 hover:scale-105"
        />
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center mt-6 lg:mt-14 lg:-mx-20">
        <motion.h2 
          ...
          className="text-[22px] sm:text-[30px] lg:text-[38px] font-semibold text-gray-900 leading-snug mb-4 max-w-xl text-center lg:text-start"
        >
        ...
        <motion.p 
          ...
          className="text-[#767676] text-[12px] sm:text-[14px] leading-5 text-justify mb-8 max-w-lg px-2 sm:px-0"
        >
          ...
          {features.map((feature, index) => (
            <motion.div
              ...
              className={`
                ...
                hover:bg-teal-50 hover:border hover:border-teal-200

...
export default function ProfilePage() {
  ...
  const [form, setForm] = useState({
    ...
    contactNumber: '', address: '', city: '', country: '',
  ...
  const inputClass = "w-full border border-gray-200 rounded-full px-5 py-3 text-sm text-gray-700 placeholder-gray-400 focus:outline-none focus:border-[#38B793] transition-all bg-white";
          ...
          <div className="bg-white p-4 md:p-8 lg:px-24 xl:px-32 shadow-[0_0_40px_rgba(0,0,0,0.03)] border-gray-50 min-h-full">
            ...
            <form onSubmit={handleSave} className="flex flex-col gap-5 max-w-4xl mx-auto">
              ...
              <div className="flex justify-center lg:justify-start mt-4">
                <button 
                  type={isEditing || !hasData ? "submit" : "button"}
                  onClick={() => !isEditing && hasData && setIsEditing(true)}
                ...
                >
                  {isEditing || !hasData ? 'Save Changes' : 'Edit Profile'}
                </button>
              </div>

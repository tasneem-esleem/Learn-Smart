    ...
    <div className="min-h-screen flex items-center justify-center bg-white px-4 sm:px-6 md:px-8">
      <div className="w-full max-w-md py-16 sm:py-20 md:py-24">
        ...
        <div className="flex flex-col gap-4">
          ...
          {/* Login Button */}
          <button className="w-full bg-[#38B793] hover:bg-teal-600 transition text-white font-medium py-3 rounded-full mt-9" onClick={handleLogin}>
            Login
          </button>
